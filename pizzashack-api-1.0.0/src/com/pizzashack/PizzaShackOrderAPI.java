...
public class PizzaShackOrderAPI {			
	...
	public Response placeOrder(Order order) {
		System.out.println("Order Service API Post Method is called...");
	...
	public Response getOrder(@PathParam("orderId") String orderId) {
		System.out.println("Inside Order Service API...Get Method is called");
	...
	public Response cancelOrder(@PathParam("orderId") String orderId) {
		System.out.println("Inside Order Service API...Delete Method is called");
	...
	public Response updateOrder(@PathParam("orderId") String orderId, Order order) {
		System.out.println("Inside Order Service API...Put Method is called");
